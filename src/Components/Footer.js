      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-start gap-8">
          <div className="text-center md:text-left md:w-1/3 mb-4 md:mb-0">
            ...
            <p>eLearning là giải pháp giúp người học phá bỏ rào cản về không gian thời gian.</p>
          </div>
          <div className="text-center md:text-left md:w-1/3 mb-4 md:mb-0">
            ...
            <p className="flex items-center">
              ...
              Website: <a href="http://ispace.edu.vn" className="underline" target="_blank" rel="noopener noreferrer">http://ispace.edu.vn</a>
            </p>
          </div>
