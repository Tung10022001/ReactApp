  ...
  return (
    <div className="">
      <img
        ...
        width="2560"
        height="1067"
        src="https://ispace.edu.vn/wp-content/uploads/2024/02/Bo-Banner-5-nganh-web_Mesa-de-trabajo-1-copy-2-2048x854.jpg"
      ...
      >
        <h6>
          <span className="text-orange-500 text-xl font-semibold dark:bg-slate-600 dark:text-white">
            Chương trình đào tạo quản trị mạng được chắc lọc kiến thức với 70%
            giờ học thực hành tại doanh nghiệp. Chỉ với thời gian đào tạo 2 năm
            3 tháng, sinh viên tốt nghiệp có thể làm việc tại 100 doanh nghiệp
            đối tác của iSPACE.
          </span>
        </h6>
      </div>
        ...
        <div className="container mx-auto">
          <div className="text-center">
            <img
              ...
              width="1919"
              height="310"
              src="https://ispace.edu.vn/wp-content/uploads/2024/02/co-hoi-nghe-nghiep-thuong-mai-dien-tu-1536x248.jpg"
    ...
    <div>
      ...
      <section className="w-full flex flex-wrap justify-center dark:bg-slate-700 dark:text-white">
        <div className="flex justify-center mx-4 my-4 dark:bg-white dark:text-white">
          <img
            src="https://ispace.edu.vn/wp-content/uploads/2024/02/Bo-7-anh-CTDT-QTM-01.jpg"
            alt=""
        ...
        <div className="flex justify-center mx-4 my-4">
          <img
            src="https://ispace.edu.vn/wp-content/uploads/2024/02/Bo-7-anh-CTDT-QTM-02.jpg"
            alt=""
            className="w-full h-auto"
          />
        </div>
        <div className="flex justify-center mx-4 my-4">
          <img
            src="https://ispace.edu.vn/wp-content/uploads/2024/02/Bo-7-anh-CTDT-QTM-03.jpg"
            alt=""
            className="w-full h-auto"
          />
        </div>
        <div className="flex justify-center mx-4 my-4">
          <img
            src="https://ispace.edu.vn/wp-content/uploads/2024/02/Bo-7-anh-CTDT-QTM-04.jpg"
            alt=""
            className="w-full h-auto"
          />
        </div>
        <div className="flex justify-center mx-4 my-4">
          <img
            src="https://ispace.edu.vn/wp-content/uploads/2024/02/Bo-7-anh-CTDT-QTM-05.jpg"
            alt=""
            className="w-full h-auto"
          />
        </div>
        <div className="flex justify-center mx-4 my-4">
          <img
            src="https://ispace.edu.vn/wp-content/uploads/2024/02/Bo-7-anh-CTDT-QTM-06.jpg"
            alt=""
            className="w-full h-auto"
          />
        </div>
        <div className="flex justify-center mx-4 my-4">
          <img
            src="https://ispace.edu.vn/wp-content/uploads/2024/02/Bo-7-anh-CTDT-QTM-07.jpg"
            alt=""
            className="w-full h-auto"
          />
        </div>
          ...
          <div className="flex">
            <div className="p-4 ">
              <p className="text-left">
                – Đại cương về CNTT
                <br />- Cơ sở lập trình
                <br />- Kiến trúc máy tính và Hệ điều hành
          ...
          <div className="flex">
            <div className="p-4">
              <p>
                ...
                <br />– Quản trị hệ thống mạng cơ bản
                <br />– Ngôn ngữ lập trình Python
                <br />– Cơ sở dữ liệu
              </p>
            </div>
          </div>
          ...
          <div className="flex">
            <div className="p-4">
              <p>
                ...
                <br />– Quản trị Windows nâng cao
                <br />– Bảo mật Linux
                <br />– Bảo trì hạ tầng mạng
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex">
            <div className="p-4 ">
              <p className="text-left">
                ...
                <br />– Phát triển ứng dụng web
                <br />– Kiểm thử xâm nhập
                <br />– Quản trị hạ tầng ảo hóa
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2">
          ...
          <div className="flex">
            <div className="p-4">
              <p>
                - Lập trình mạng
                <br />- Phòng thủ mạng nâng cao
                <br />- Giám sát mạng
                <br />- Ứng cứu sự cố mạng
              </p>
            </div>
          </div>
        </div>
